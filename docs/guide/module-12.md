...
4. **Guía para líderes técnicos** en [docs/guide/tech-lead-questions.md](/guide/tech-lead-questions) — las preguntas que va a hacer quien evalúa seniority (arquitectura, rendimiento, seguridad, operación) con respuestas sostenibles por archivos reales, y el guion de 60 s para las tres preguntas que "seguro" aparecen.
